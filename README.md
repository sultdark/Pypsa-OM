...
PyPSA-Oman represents the national electricity system through a spatially clustered network and uses **2,920 weighted three-hourly snapshots** representing a full year. The current model includes a validated **2024 base-year case**, a preliminary **2030 transition scenario**, and a **2050 zero-direct-emission scenario**.
...
<p align="center">
  <b>Figure:</b> Spatial distribution and technology mix of current generation capacity represented in PyPSA-Oman. Pie-chart size indicates installed capacity, while colours indicate generation technologies.
</p>
